...
#read all the text in texts array and corresponding to each SMS meesage entry labels
# would be in labels


print('Found %s texts.' % len(df['SMS'].tolist()))
...
#print('here are sequences {0}'.format(sequences))
...
#print('here is fdata {0}'.format(data))
